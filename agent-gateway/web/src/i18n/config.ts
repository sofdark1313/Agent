...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settings.remoteInfoBanner":
      "启用后，本地 Agent 将通过 gRPC 双向流连接云端 Gateway。你可以在浏览器中通过 WebUI 远程发送 Chat 消息、管理 Cron 任务和查看历史记录。所有工具执行仍在本地完成，远程端仅转发指令和结果。",
  ...
  "en-US": {
    ...
    "settings.systemToolsBuiltinDesc":
      "Built-in tools that Agent registers automatically in Agent mode. Read-only list; click the eye icon for details.",
    "settings.systemToolsCustomDesc":
    ...
    "settings.remoteInfoBanner":
      "When enabled, the local Agent connects to the cloud Gateway via gRPC bidirectional streaming. You can remotely send Chat messages, manage Cron tasks, and view history through the WebUI in your browser. All tool execution remains local — the remote end only relays commands and results.",
