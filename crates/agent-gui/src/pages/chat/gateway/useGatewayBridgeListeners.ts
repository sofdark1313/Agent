...
const gatewayBridgeRequestRegistry = (() => {
  const root = globalThis as typeof globalThis & {
    __AGENT_GATEWAY_BRIDGE_REQUESTS__?: GatewayBridgeRequestRegistry;
  };
  root.__AGENT_GATEWAY_BRIDGE_REQUESTS__ ??= {
  ...
  root.__AGENT_GATEWAY_BRIDGE_REQUESTS__.pendingConversationIds ??= new Set<string>();
  return root.__AGENT_GATEWAY_BRIDGE_REQUESTS__;
})();
