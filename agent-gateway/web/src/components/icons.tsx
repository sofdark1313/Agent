...
import ArrowLeftSource from "~icons/fluent/arrow-left-20-regular";
import ArrowUpSource from "~icons/fluent/arrow-up-20-regular";
import BanSource from "~icons/fluent/prohibited-20-regular";
import BlendSource from "~icons/fluent/layer-diagonal-20-regular";
import BookOpenSource from "~icons/fluent/book-open-20-regular";
import BotSource from "~icons/fluent/bot-20-regular";
import BrainSource from "~icons/fluent/brain-circuit-20-regular";
import BrushCleaningSource from "~icons/fluent/eraser-20-regular";
import CableSource from "~icons/fluent/plug-connected-20-regular";
import CheckSource from "~icons/fluent/checkmark-20-regular";
import ChevronDownSource from "~icons/fluent/chevron-down-20-regular";
import ChevronRightSource from "~icons/fluent/chevron-right-20-regular";
import ChevronUpSource from "~icons/fluent/chevron-up-20-regular";
import CircleSource from "~icons/fluent/circle-20-regular";
import CheckCircle2Source from "~icons/fluent/checkmark-circle-20-regular";
import CirclePlusSource from "~icons/fluent/add-circle-20-regular";
import XCircleSource from "~icons/fluent/dismiss-circle-20-regular";
import ClipboardPasteSource from "~icons/fluent/clipboard-paste-20-regular";
import Clock3Source from "~icons/fluent/clock-20-regular";
import CloudSource from "~icons/fluent/cloud-20-regular";
import CloudDownloadSource from "~icons/fluent/cloud-arrow-down-20-regular";
import CopySource from "~icons/fluent/copy-20-regular";
import CpuSource from "~icons/fluent/desktop-20-regular";
import TargetSource from "~icons/fluent/target-arrow-20-regular";
import DownloadSource from "~icons/fluent/arrow-download-20-regular";
import Globe2Source from "~icons/fluent/globe-20-regular";
import MoreHorizontalSource from "~icons/fluent/more-horizontal-20-regular";
import ExternalLinkSource from "~icons/fluent/open-20-regular";
import EyeSource from "~icons/fluent/eye-20-regular";
import EyeOffSource from "~icons/fluent/eye-off-20-regular";
import FileSource from "~icons/fluent/document-20-regular";
import FilePenLineSource from "~icons/fluent/document-edit-20-regular";
import FileTextSource from "~icons/fluent/document-text-20-regular";
import FolderSource from "~icons/fluent/folder-20-regular";
import FolderClosedSource from "~icons/fluent/folder-20-regular";
import FolderOpenSource from "~icons/fluent/folder-open-20-regular";
import FolderTreeSource from "~icons/fluent/folder-open-vertical-20-regular";
import GitBranchSource from "~icons/fluent/branch-compare-20-regular";
import GitCommitHorizontalSource from "~icons/fluent/branch-compare-20-regular";
import GithubSource from "~icons/fluent/code-circle-20-regular";
import GlobeSource from "~icons/fluent/globe-20-regular";
import GripVerticalSource from "~icons/fluent/re-order-dots-vertical-20-regular";
import HistorySource from "~icons/fluent/history-20-regular";
import ImageIconSource from "~icons/fluent/image-20-regular";
import ImageOffSource from "~icons/fluent/image-off-20-regular";
import InfoSource from "~icons/fluent/info-20-regular";
import KeySource from "~icons/fluent/key-20-regular";
import LayoutGridSource from "~icons/fluent/grid-20-regular";
import LightbulbSource from "~icons/fluent/lightbulb-20-regular";
import Link2Source from "~icons/fluent/link-20-regular";
import ListSource from "~icons/fluent/list-20-regular";
import ListChecksSource from "~icons/fluent/task-list-ltr-20-regular";
import Loader2Source from "~icons/fluent/spinner-ios-20-regular";
import LoaderCircleSource from "~icons/fluent/spinner-ios-20-regular";
import LockSource from "~icons/fluent/lock-closed-20-regular";
import Maximize2Source from "~icons/fluent/maximize-20-regular";
import MessageSquareSource from "~icons/fluent/chat-20-regular";
import MessageSquareTextSource from "~icons/fluent/chat-20-regular";
import Minimize2Source from "~icons/fluent/arrow-minimize-20-regular";
import MinusSource from "~icons/fluent/subtract-20-regular";
import MonitorSmartphoneSource from "~icons/fluent/desktop-20-regular";
import MoonSource from "~icons/fluent/weather-moon-20-regular";
import PanelLeftSource from "~icons/fluent/panel-left-20-regular";
import PanelLeftCloseSource from "~icons/fluent/panel-left-contract-20-regular";
import PanelRightCloseSource from "~icons/fluent/panel-right-contract-20-regular";
import PanelRightOpenSource from "~icons/fluent/panel-right-expand-20-regular";
import PaperclipSource from "~icons/fluent/attach-20-regular";
import Edit3Source from "~icons/fluent/pen-20-regular";
import PencilSource from "~icons/fluent/edit-20-regular";
import PinSource from "~icons/fluent/pin-20-regular";
import PinOffSource from "~icons/fluent/pin-off-20-regular";
import PlaySource from "~icons/fluent/play-20-regular";
import PlugSource from "~icons/fluent/plug-connected-20-regular";
import PlusSource from "~icons/fluent/add-20-regular";
import RadioSource from "~icons/fluent/radio-button-20-regular";
import Redo2Source from "~icons/fluent/arrow-redo-20-regular";
import RefreshCwSource from "~icons/fluent/arrow-sync-20-regular";
import ReplaceSource from "~icons/fluent/arrow-swap-20-regular";
import RotateCwSquareSource from "~icons/fluent/rotate-right-20-regular";
import SaveSource from "~icons/fluent/save-20-regular";
import ScanTextSource from "~icons/fluent/scan-text-20-regular";
import ScissorsSource from "~icons/fluent/cut-20-regular";
import ScrollTextSource from "~icons/fluent/document-text-20-regular";
import SearchSource from "~icons/fluent/search-20-regular";
import SendSource from "~icons/fluent/send-20-regular";
import ServerSource from "~icons/fluent/server-20-regular";
import SettingsSource from "~icons/fluent/settings-20-regular";
import Settings2Source from "~icons/fluent/settings-chat-20-regular";
import Share2Source from "~icons/fluent/share-20-regular";
import ShieldSource from "~icons/fluent/shield-20-regular";
import SparklesSource from "~icons/fluent/sparkle-20-regular";
import SquareSource from "~icons/fluent/square-20-regular";
import SquarePenSource from "~icons/fluent/note-edit-20-regular";
import SunSource from "~icons/fluent/weather-sunny-20-regular";
import TagSource from "~icons/fluent/tag-20-regular";
import TerminalSource from "~icons/fluent/prompt-20-regular";
import TextSelectSource from "~icons/fluent/text-grammar-checkmark-20-regular";
import Trash2Source from "~icons/fluent/delete-20-regular";
import AlertTriangleSource from "~icons/fluent/warning-20-regular";
import Undo2Source from "~icons/fluent/arrow-undo-20-regular";
import UploadSource from "~icons/fluent/arrow-upload-20-regular";
import WifiSource from "~icons/fluent/wifi-1-20-regular";
import WifiOffSource from "~icons/fluent/wifi-off-20-regular";
import WrenchSource from "~icons/fluent/wrench-20-regular";
import XSource from "~icons/fluent/dismiss-20-regular";
import ZapSource from "~icons/fluent/flash-20-regular";
...
export const ArrowUp = createIcon(ArrowUpSource);
...
import AlertCircleSource from "~icons/gravity-ui/circle-exclamation";
import ArrowRightSource from "~icons/gravity-ui/arrow-right";
import HardDriveSource from "~icons/gravity-ui/hard-drive";
import HomeSource from "~icons/gravity-ui/house";
import LogOutSource from "~icons/gravity-ui/arrow-right-from-square";
import TimerSource from "~icons/gravity-ui/clock";
...
import UserSource from "~icons/gravity-ui/person";
