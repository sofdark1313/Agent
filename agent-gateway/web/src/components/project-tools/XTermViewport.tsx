...
function terminalTheme(theme: "light" | "dark") {
  if (theme === "dark") {
    return {
      ...
      scrollbarSliderBackground: "rgba(148, 163, 184, 0.15)",
      scrollbarSliderHoverBackground: "rgba(148, 163, 184, 0.25)",
      scrollbarSliderActiveBackground: "rgba(148, 163, 184, 0.38)",
  ...
  return {
    ...
    selectionInactiveBackground: "#d8e4f5",
...
export function XTermViewport({
  ...
  useEffect(() => {
    ...
    const term = new XTerm({
      ...
      disableStdin: true,
      fontFamily:
        'Consolas, "Cascadia Code", "Cascadia Mono", "Segoe UI Mono", "Ubuntu Mono", "Roboto Mono", monospace',
      fontSize: 13,
      fontWeight: "400",
      fontWeightBold: "600",
      lineHeight: 1.2,
