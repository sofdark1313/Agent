...
const (
	AgentGateway_AgentConnect_FullMethodName         = "/agent.gateway.v1.AgentGateway/AgentConnect"
	AgentGateway_AgentTerminalConnect_FullMethodName = "/agent.gateway.v1.AgentGateway/AgentTerminalConnect"
	AgentGateway_Authenticate_FullMethodName         = "/agent.gateway.v1.AgentGateway/Authenticate"
)
...
var AgentGateway_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "agent.gateway.v1.AgentGateway",
