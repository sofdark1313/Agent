...
var websocketRequestHandlers = map[string]websocketRequestHandler{
	...
	"process.snapshot":               (*websocketConnection).handleProcessSnapshot,
	"process.stop":                   (*websocketConnection).handleProcessStop,
	"process.read_log":               (*websocketConnection).handleProcessReadLog,
	"process.clear":                  (*websocketConnection).handleProcessClear,
	...
	"git.delete_branch":              (*websocketConnection).handleGitRequest,
	"git.rename_branch":              (*websocketConnection).handleGitRequest,
	"git.stash_push":                 (*websocketConnection).handleGitRequest,
	"git.stash_pop":                  (*websocketConnection).handleGitRequest,
	...
	"workspace.subscribe":            (*websocketConnection).handleWorkspaceSubscribe,
	"workspace.unsubscribe":          (*websocketConnection).handleWorkspaceUnsubscribe,
	"chat.activities":                (*websocketConnection).handleChatActivities,
	"chat.prepare":                   (*websocketConnection).handleChatPrepare,
