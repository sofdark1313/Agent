...
export const translations: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    ...
    "window.close": "关闭",
    "window.menu.file": "文件",
    "window.menu.newChat": "新建对话",
    "window.menu.newWindow": "新建窗口",
    "window.menu.newTask": "新建任务",
    "window.menu.newProjectlessTask": "新建无项目任务",
    "window.menu.openFolder": "打开文件夹…",
    "window.menu.close": "关闭",
    "window.menu.settings": "设置…",
    "window.menu.exit": "退出",
    "window.menu.edit": "编辑",
    "window.menu.focusComposer": "聚焦聊天输入框",
    "window.menu.undo": "撤销",
    "window.menu.redo": "重做",
    "window.menu.cut": "剪切",
    "window.menu.copy": "复制",
    "window.menu.paste": "粘贴",
    "window.menu.delete": "删除",
    "window.menu.selectAll": "全选",
    "window.menu.view": "视图",
    "window.menu.toggleSidebar": "切换侧栏",
    "window.menu.toggleProjectTools": "切换项目工具",
    "window.menu.appearance": "切换主题",
    "window.menu.help": "帮助",
    "window.menu.about": "关于 Agent",
    ...
    "chat.exitConfirmTitle": "退出 Agent？",
    ...
    "chat.composer.files": "文件",
    "chat.composer.thinking": "Thinking",
    "chat.composer.webSearch": "联网搜索",
    "chat.composer.agentAccess": "Agent 模式",
    "chat.composer.chatAccess": "Chat 模式",
    "chat.composer.agentAccessTooltip": "允许模型调用当前已启用的工具",
    "chat.composer.chatAccessTooltip": "仅生成文本，不调用工具",
    "chat.mode.menuTitle": "对话模式",
    "chat.mode.chatTitle": "Chat",
    "chat.mode.chatDescription": "对话、写作与分析",
    "chat.mode.agentTitle": "Agent",
    "chat.mode.agentDescription": "编码、调用工具与执行任务",
    "chat.access.menuTitle": "如何运行 Agent？",
    "chat.access.askApproval": "请求批准",
    "chat.access.askApprovalDesc": "读取自动进行，修改、命令与外部访问需确认",
    "chat.access.agentAutomatic": "自动执行",
    "chat.access.agentAutomaticDesc": "允许使用当前已启用的工具处理项目",
    "chat.access.fullAccess": "完全访问",
    "chat.access.fullAccessDesc": "自动执行所有已启用工具，并记录完整调试请求与响应",
    "chat.access.custom": "自定义",
    "chat.access.customDesc": "在设置中配置审批类别与工作区边界",
    "chat.approval.title": "Agent 请求执行操作",
    "chat.approval.queueCount": "还有 {count} 个请求",
    "chat.approval.outsideWorkspace": "此操作将访问当前工作区之外的位置",
    "chat.approval.category.read": "读取文件或项目信息",
    "chat.approval.category.write": "修改工作区内容",
    "chat.approval.category.command": "运行本地命令或进程",
    "chat.approval.category.network": "访问网络资源",
    "chat.approval.category.mcp": "调用 MCP 集成工具",
    "chat.approval.category.system": "更改应用或系统状态",
    "chat.approval.category.internal": "执行 Agent 内部操作",
    "chat.approval.deny": "拒绝",
    "chat.approval.allowSession": "本次任务允许",
    ...
    /* ── RAG Hub ── */
    "ragHub.navTitle": "RAG 中心",
    "ragHub.subtitle": "配置外部知识服务、上传文档，并让 Agent 通过内置只读工具检索",
    "ragHub.common.unknown": "未知",
    "ragHub.common.saving": "保存中",
    "ragHub.common.displayName": "显示名称",
    "ragHub.common.clear": "清空",
    "ragHub.common.create": "新建",
    "ragHub.common.refresh": "刷新",
    "ragHub.common.cancel": "取消",
    "ragHub.common.creating": "创建中",
    "ragHub.common.selectAll": "全选",
    "ragHub.common.notReturned": "未返回",
    "ragHub.common.delete": "删除",
    "ragHub.service.add": "新增服务",
    "ragHub.service.title": "服务",
    "ragHub.service.defaultBadge": "默认",
    "ragHub.service.empty": "先保存一个已经运行的 RAG 服务。",
    "ragHub.service.connectionConfig": "连接配置",
    "ragHub.service.delete": "删除服务",
    "ragHub.service.testSavedTitle": "测试已保存的服务配置",
    "ragHub.service.saveFirstTitle": "请先保存当前修改",
    "ragHub.service.testing": "测试中",
    "ragHub.service.test": "测试连接",
    "ragHub.service.save": "保存配置",
    "ragHub.service.id": "服务 ID",
    "ragHub.service.managementCredential": "管理凭证",
    "ragHub.service.agentCredential": "Agent 凭证",
    "ragHub.service.protocolVersion": "协议版本",
    "ragHub.service.capabilityHealth": "能力状态",
    "ragHub.service.capabilityStatus.untested": "未测试",
    "ragHub.service.capabilityStatus.valid": "有效",
    "ragHub.service.capabilityStatus.expired": "已过期",
    "ragHub.service.capabilityStatus.incompatible": "不兼容",
    "ragHub.service.adapter": "适配器",
    "ragHub.service.adapterHint": "首版固定使用 ragent。",
    "ragHub.service.timeout": "请求超时（ms）",
    "ragHub.service.timeoutHint": "允许范围：{min}–{max} ms。",
    "ragHub.service.timeoutInvalid": "请求超时必须是 1,000–120,000 之间的整数毫秒值。",
    "ragHub.service.baseUrl": "Base URL",
    "ragHub.service.enable": "启用服务",
    "ragHub.service.setDefault": "设为默认",
    "ragHub.service.enableForAgent": "开放给 Agent",
    "ragHub.credential.noEcho": "密钥保存后不会回显到页面。",
    "ragHub.credential.management": "管理 API Key",
    "ragHub.credential.agent": "Agent API Key",
    "ragHub.credential.configured": "已存入系统凭证库",
    "ragHub.credential.configuredShort": "已配置",
    "ragHub.credential.notConfigured": "未配置",
    "ragHub.credential.replace": "更换",
    "ragHub.credential.nativeInput": "原生录入",
    "ragHub.credential.managementHint": "密钥在系统原生安全输入框中录入，由 Rust 直接写入凭证库。",
    "ragHub.credential.agentHint": "前端只接收是否已配置，不会读取、保存或传输密钥。",
    "ragHub.credential.knowledgeBaseAllowlist": "Agent 知识库白名单",
    "ragHub.knowledgeBase.title": "知识库",
    "ragHub.knowledgeBase.subtitle": "选择文档要进入的知识库，管理操作使用管理凭证。",
    "ragHub.knowledgeBase.searchLabel": "搜索知识库",
    "ragHub.knowledgeBase.searchPlaceholder": "按名称或 ID 搜索知识库",
    "ragHub.knowledgeBase.noMatches": "没有匹配的知识库。",
    "ragHub.knowledgeBase.agentAccess": "Agent 访问",
    "ragHub.knowledgeBase.addToAgent": "加入 Agent",
    "ragHub.knowledgeBase.removeFromAgent": "移出 Agent",
    "ragHub.knowledgeBase.allowlistSaveRetest":
      "白名单更改仅保存在当前草稿中；请保存配置并重新测试连接。",
    "ragHub.knowledgeBase.name": "知识库名称",
    "ragHub.knowledgeBase.namePlaceholder": "公司制度",
    "ragHub.knowledgeBase.embeddingModel": "嵌入模型",
    "ragHub.knowledgeBase.collectionName": "集合名称",
    "ragHub.knowledgeBase.createHint": '创建需要管理 Key 配置 knowledgeBaseIds=["*"]。',
    "ragHub.knowledgeBase.create": "创建知识库",
    "ragHub.knowledgeBase.documentCount": "{count} 个文档",
    "ragHub.knowledgeBase.empty": "点击刷新读取知识库，或直接新建一个空知识库。",
    "ragHub.knowledgeBase.saveName": "保存名称",
    "ragHub.knowledgeBase.deleteDocumentsFirst": "请先删除知识库中的文档",
    "ragHub.knowledgeBase.deleteEmpty": "删除空知识库",
    "ragHub.knowledgeBase.modelLabel": "模型：",
    "ragHub.knowledgeBase.collectionLabel": "集合：",
    "ragHub.document.title": "文档入库",
    "ragHub.document.status.pending": "等待处理",
    "ragHub.document.status.running": "处理中",
    "ragHub.document.status.succeeded": "已入库",
    "ragHub.document.status.failed": "处理失败",
    "ragHub.document.status.cancelled": "已取消",
    "ragHub.document.unknownSize": "未知大小",
    "ragHub.document.uploadHint": "本地文件由 Rust 流式上传，单文件上限 {size}。",
    "ragHub.document.uploadUnsupported": "当前服务未声明文件上传能力。",
    "ragHub.document.processMode": "处理模式",
    "ragHub.document.chunkMode": "分块入库",
    "ragHub.document.pipelineMode": "Pipeline 入库",
    "ragHub.document.chunkStrategy": "分块策略",
    "ragHub.document.pipelineLabel": "Pipeline",
    "ragHub.document.fileUploadDisabled": "服务未启用文件上传",
    "ragHub.document.filePlaceholder": "请选择要入库的文档",
    "ragHub.document.selectKnowledgeBaseFirst": "请先选择知识库",
    "ragHub.document.selectFile": "选择文件",
    "ragHub.document.ingesting": "入库中",
    "ragHub.document.upload": "上传入库",
    "ragHub.document.urlImportDisabled": "服务未启用 URL 入库",
    "ragHub.document.downloading": "下载中",
    "ragHub.document.urlImport": "URL 入库",
    "ragHub.document.urlSecurityHint":
      "仅允许公网 HTTP(S) 文档；内网、回环地址和跳转到内网的链接会被拒绝。",
    "ragHub.document.urlCapabilityDisabled": "当前服务 capabilities 已关闭 URL 入库。",
    "ragHub.document.jobCurrent": "当前任务：",
    "ragHub.document.stageComplete": "完成",
    "ragHub.document.selectKnowledgeBaseEmpty": "先刷新并选择一个知识库。",
    "ragHub.document.empty": "这个知识库还没有文档。",
    "ragHub.document.chunkCount": "{count} 个 Chunk",
    "ragHub.document.hideChunks": "收起 Chunk",
    "ragHub.document.showChunks": "查看 Chunk",
    "ragHub.document.retrying": "重试中",
    "ragHub.document.retry": "重试入库",
    "ragHub.document.showJobHistory": "查看任务历史",
    "ragHub.document.hideJobHistory": "收起任务历史",
    "ragHub.document.jobHistory": "入库任务历史",
    "ragHub.document.jobAttempt": "第 {attempt} 次尝试",
    "ragHub.document.jobOperation": "操作：{operation}",
    "ragHub.document.jobStarted": "开始：{time}",
    "ragHub.document.jobCompleted": "完成：{time}",
    "ragHub.document.jobParent": "父任务：{jobId}",
    "ragHub.document.jobError": "{code}：{message}",
    "ragHub.document.characterCount": "{count} 个字符",
    "ragHub.document.tokenCount": "{count} 个 token",
    "ragHub.document.noChunks": "暂无 Chunk。",
    "ragHub.search.title": "检索实验",
    "ragHub.search.subtitle": "一次完成召回与可选重排。",
    "ragHub.search.scope": "检索范围",
    "ragHub.search.scopeHint": "可同时选择多个知识库",
    "ragHub.search.loadKnowledgeBasesFirst": "先加载知识库，再选择检索范围。",
    "ragHub.search.queryLabel": "检索问题",
    "ragHub.search.queryPlaceholder": "输入要检索的问题",
    "ragHub.search.topK": "召回数量 Top K",
    "ragHub.search.serviceLimit": "服务上限 {limit}",
    "ragHub.search.enableRerank": "启用重排",
    "ragHub.search.rerankHint": "优化最终排序",
    "ragHub.search.rerankUnsupported": "服务未声明此能力",
    "ragHub.search.topN": "最终数量 Top N",
    "ragHub.search.searching": "检索中",
    "ragHub.search.start": "开始检索",
    "ragHub.search.rerankingCandidates": "正在独立重排",
    "ragHub.search.rerankCandidates": "重排当前候选",
    "ragHub.search.searchingAnnouncement": "正在检索知识库",
    "ragHub.search.rerankingAnnouncement": "正在独立重排当前候选",
    "ragHub.search.selectedKnowledgeBases": "已选 {count} 个知识库",
    "ragHub.search.capabilityLimits": " · 已按服务能力限制参数",
    "ragHub.search.localLimits": " · 使用本地安全上限",
    "ragHub.search.rerankCandidateCount": " · 当前可提交 {count} 条候选进行独立重排",
    "ragHub.search.rerankCapabilityRequired": " · 服务 capabilities 明确声明 rerank 后可用",
    "ragHub.search.resultViewLegend": "结果视图",
    "ragHub.search.results": "检索结果",
    "ragHub.search.rerankedResults": "独立重排",
    "ragHub.search.searchTiming": "检索耗时",
    "ragHub.search.retrievalTiming": "召回 {ms} ms",
    "ragHub.search.rerankTiming": "重排 {ms} ms",
    "ragHub.search.totalTiming": "总计 {ms} ms",
    "ragHub.search.requestId": "请求 {id}",
    "ragHub.search.warningRerankUnavailable": "重排服务暂不可用，已回退为原始召回顺序。",
    "ragHub.search.rawResultsFallback": "当前服务未返回原始召回列表，左侧暂用最终结果兼容展示。",
    "ragHub.search.rawResults": "原始召回",
    "ragHub.search.rawResultsSubtitle": "向量检索返回的候选顺序",
    "ragHub.search.finalResults": "最终结果",
    "ragHub.search.finalResultsSubtitle": "重排后交给 Agent 的结果",
    "ragHub.search.independentRerankTiming": "独立重排耗时",
    "ragHub.search.candidateTiming": "候选处理 {ms} ms",
    "ragHub.search.candidateInput": "候选输入",
    "ragHub.search.candidateInputSubtitle": "本次提交给独立重排接口的候选快照",
    "ragHub.search.independentRerankSubtitle": "不覆盖原检索响应的独立排序结果",
    "ragHub.search.hitCount": "{count} 条",
    "ragHub.search.sourceDocumentUnavailable": "来源文档未返回",
    "ragHub.search.rankBeforeAfter": "重排前 → 重排后",
    "ragHub.search.currentRank": "当前排名",
    "ragHub.search.noHits": "没有命中结果",
    "ragHub.search.empty": "输入问题后，可对比原始召回与最终重排结果。",
    "ragHub.notice.serviceSaved": "服务配置已保存；凭证请通过系统原生安全输入单独录入。",
    "ragHub.notice.credentialCancelled": "已取消凭证录入，现有配置未改变。",
    "ragHub.notice.credentialSaved": "凭证已由 Rust 直接写入系统凭证库，前端未接触密钥内容。",
    "ragHub.notice.credentialCleared": "凭证已从系统凭证库清除。",
    "ragHub.notice.serviceDeleted": "服务配置和对应凭证已删除。",
    "ragHub.notice.connectionSucceeded": "连接成功，协议版本 {version}。",
    "ragHub.notice.knowledgeBaseCreated": "知识库“{name}”已创建。",
    "ragHub.notice.knowledgeBaseRenamed": "知识库已重命名为“{name}”。",
    "ragHub.notice.knowledgeBaseDeleted": "知识库“{name}”已删除。",
    "ragHub.notice.rerankComplete": "独立重排完成，已切换到独立重排视图。",
    "ragHub.notice.documentSubmitted": "文档已提交，正在等待入库",
    "ragHub.notice.urlDocumentSubmitted": "URL 文档已安全下载，正在等待入库",
    "ragHub.notice.jobAccepted": "{message}（任务 {jobId}）。",
    "ragHub.notice.documentSucceeded": "文档已完成解析、分块和向量入库。",
    "ragHub.notice.pollingPaused": "轮询已暂停，任务 {jobId} 仍在后台运行；稍后点击刷新查看结果。",
    "ragHub.notice.retrySubmitted": "已重新提交文档入库任务。",
    "ragHub.notice.retrySucceeded": "重试成功，文档已经入库。",
    "ragHub.notice.documentDeleted": "文档、Chunk 和向量已删除。",
    "ragHub.error.saveBeforeCredential": "请先保存服务配置，再打开系统原生凭证输入框。",
    "ragHub.error.saveBeforeTest": "请先保存当前服务配置和 API Key，再测试连接。",
    "ragHub.error.knowledgeBaseAdminRequired":
      '创建知识库需要管理 Key 配置 knowledgeBaseIds=["*"]。',
    "ragHub.error.invalidIngestionConfig": "入库配置无效",
    "ragHub.error.documentFailed": "文档入库失败，可以点击重试。",
    "ragHub.error.noRetryableJob": "当前文档没有可重试的失败任务。",
    "ragHub.error.retryFailed": "重试后仍然失败。",
    "ragHub.confirm.clearCredential": "确定清除系统凭证库中的该 RAG 凭证吗？",
    "ragHub.confirm.deleteKnowledgeBase": "确定删除空知识库“{name}”吗？该操作无法撤销。",
    "ragHub.confirm.deleteDocument": "确定删除文档“{name}”吗？对应 Chunk 和向量也会被清理。",
    ...
    "settings.groupIntegrationsCoding": "集成与编码",
    ...
    "settings.aboutRestartingDesc": "Agent 正在退出并重新打开。",
    ...
    "settings.agentDevModeDesc":
      "与 Agent 模式一致，但会把当前对话的流式请求与返回逐行写入 ~/.agent/debug/<对话ID>.jsonl",
    ...
    "settings.systemToolsBuiltinDesc": "Agent 在工具模式下自动注册的内置工具，此处仅供查阅。",
    ...
    "settings.approval.allowNetworkDesc": "HTTP 等网络工具无需逐次确认。",
    "settings.approval.allowMcp": "自动允许 MCP 工具",
    "settings.approval.allowMcpDesc": "已启用的 MCP 集成可直接执行操作。",
    "settings.approval.allowOutsideWorkspace": "自动允许工作区外访问",
    "settings.approval.allowOutsideWorkspaceDesc": "文件路径或命令工作目录可以越过当前项目边界。",
    ...
    "settings.remoteDesc": "通过云端 Gateway 远程控制本地 Agent",
    ...
    "settings.skillsImportDesc":
      "扫描本机 Claude Code、Codex、CodeBuddy 的技能目录，勾选后导入到 Agent。",
  ...
  "en-US": {
    ...
    "window.menu.newChat": "New chat",
    "window.menu.newWindow": "New Window",
    "window.menu.newTask": "New Task",
    "window.menu.newProjectlessTask": "New Projectless Task",
    "window.menu.openFolder": "Open Folder…",
    "window.menu.close": "Close",
    "window.menu.settings": "Settings…",
    "window.menu.exit": "Exit",
    "window.menu.edit": "Edit",
    "window.menu.focusComposer": "Focus chat input",
    "window.menu.undo": "Undo",
    "window.menu.redo": "Redo",
    "window.menu.cut": "Cut",
    "window.menu.copy": "Copy",
    "window.menu.paste": "Paste",
    "window.menu.delete": "Delete",
    "window.menu.selectAll": "Select All",
    "window.menu.view": "View",
    "window.menu.toggleSidebar": "Toggle sidebar",
    "window.menu.toggleProjectTools": "Toggle project tools",
    "window.menu.appearance": "Toggle appearance",
    "window.menu.help": "Help",
    "window.menu.about": "About Agent",
    ...
    "chat.exitConfirmTitle": "Exit Agent?",
    ...
    "chat.composer.files": "Files",
    "chat.composer.thinking": "Thinking",
    "chat.composer.webSearch": "Web search",
    "chat.composer.agentAccess": "Agent mode",
    "chat.composer.chatAccess": "Chat mode",
    "chat.composer.agentAccessTooltip": "Allow the model to use currently enabled tools",
    "chat.composer.chatAccessTooltip": "Generate text without calling tools",
    "chat.mode.menuTitle": "Conversation mode",
    "chat.mode.chatTitle": "Chat",
    "chat.mode.chatDescription": "Converse, write, and analyze",
    "chat.mode.agentTitle": "Agent",
    ...
    "chat.approval.category.network": "Access a network resource",
    "chat.approval.category.mcp": "Call an MCP integration tool",
    "chat.approval.category.system": "Change application or system state",
    "chat.approval.category.internal": "Run an internal Agent action",
    "chat.approval.deny": "Deny",
    "chat.approval.allowSession": "Allow for this task",
    ...
    /* ── RAG Hub ── */
    "ragHub.navTitle": "RAG Hub",
    "ragHub.subtitle":
      "Configure external knowledge services, upload documents, and let Agent search them with built-in read-only tools",
    "ragHub.common.unknown": "Unknown",
    "ragHub.common.saving": "Saving",
    "ragHub.common.displayName": "Display Name",
    "ragHub.common.clear": "Clear",
    "ragHub.common.create": "New",
    "ragHub.common.refresh": "Refresh",
    "ragHub.common.cancel": "Cancel",
    "ragHub.common.creating": "Creating",
    "ragHub.common.selectAll": "Select All",
    "ragHub.common.notReturned": "Not returned",
    "ragHub.common.delete": "Delete",
    "ragHub.service.add": "Add Service",
    "ragHub.service.title": "Services",
    "ragHub.service.defaultBadge": "Default",
    "ragHub.service.empty": "Save a running RAG service to get started.",
    "ragHub.service.connectionConfig": "Connection Settings",
    "ragHub.service.delete": "Delete Service",
    "ragHub.service.testSavedTitle": "Test the saved service configuration",
    "ragHub.service.saveFirstTitle": "Save the current changes first",
    "ragHub.service.testing": "Testing",
    "ragHub.service.test": "Test Connection",
    "ragHub.service.save": "Save Settings",
    "ragHub.service.id": "Service ID",
    "ragHub.service.managementCredential": "Management Credential",
    "ragHub.service.agentCredential": "Agent Credential",
    "ragHub.service.protocolVersion": "Protocol Version",
    "ragHub.service.capabilityHealth": "Capability Status",
    "ragHub.service.capabilityStatus.untested": "Not Tested",
    "ragHub.service.capabilityStatus.valid": "Valid",
    "ragHub.service.capabilityStatus.expired": "Expired",
    "ragHub.service.capabilityStatus.incompatible": "Incompatible",
    "ragHub.service.adapter": "Adapter",
    "ragHub.service.adapterHint": "The initial release uses the fixed ragent adapter.",
    "ragHub.service.timeout": "Request Timeout (ms)",
    "ragHub.service.timeoutHint": "Allowed range: {min}–{max} ms.",
    "ragHub.service.timeoutInvalid":
      "Request timeout must be an integer from 1,000 to 120,000 milliseconds.",
    "ragHub.service.baseUrl": "Base URL",
    "ragHub.service.enable": "Enable Service",
    "ragHub.service.setDefault": "Set as Default",
    "ragHub.service.enableForAgent": "Enable for Agent",
    "ragHub.credential.noEcho": "Saved credentials are never displayed on this page.",
    "ragHub.credential.management": "Management API Key",
    "ragHub.credential.agent": "Agent API Key",
    "ragHub.credential.configured": "Stored in the system credential vault",
    "ragHub.credential.configuredShort": "Configured",
    "ragHub.credential.notConfigured": "Not configured",
    "ragHub.credential.replace": "Replace",
    "ragHub.credential.nativeInput": "Secure Input",
    "ragHub.credential.managementHint":
      "Enter the key in the system-native secure prompt. Rust writes it directly to the credential vault.",
    "ragHub.credential.agentHint":
      "The frontend only receives whether a key is configured; it never reads, stores, or transmits the key.",
    "ragHub.credential.knowledgeBaseAllowlist": "Agent Knowledge Base Allowlist",
    "ragHub.knowledgeBase.title": "Knowledge Bases",
    "ragHub.knowledgeBase.subtitle":
      "Choose where documents are stored. Management operations use the management credential.",
    "ragHub.knowledgeBase.searchLabel": "Search Knowledge Bases",
    "ragHub.knowledgeBase.searchPlaceholder": "Search by name or ID",
    "ragHub.knowledgeBase.noMatches": "No matching knowledge bases.",
    "ragHub.knowledgeBase.agentAccess": "Agent Access",
    "ragHub.knowledgeBase.addToAgent": "Add to Agent",
    "ragHub.knowledgeBase.removeFromAgent": "Remove from Agent",
    "ragHub.knowledgeBase.allowlistSaveRetest":
      "Allowlist changes are only in the current draft. Save the settings and test the connection again.",
    "ragHub.knowledgeBase.name": "Knowledge Base Name",
    "ragHub.knowledgeBase.namePlaceholder": "Company policies",
    "ragHub.knowledgeBase.embeddingModel": "Embedding Model",
    "ragHub.knowledgeBase.collectionName": "Collection Name",
    "ragHub.knowledgeBase.createHint":
      'Creation requires a management key with knowledgeBaseIds=["*"].',
    "ragHub.knowledgeBase.create": "Create Knowledge Base",
    "ragHub.knowledgeBase.documentCount": "{count} documents",
    "ragHub.knowledgeBase.empty":
      "Refresh to load knowledge bases, or create an empty knowledge base.",
    "ragHub.knowledgeBase.saveName": "Save Name",
    "ragHub.knowledgeBase.deleteDocumentsFirst":
      "Delete the documents in this knowledge base first",
    "ragHub.knowledgeBase.deleteEmpty": "Delete Empty Knowledge Base",
    "ragHub.knowledgeBase.modelLabel": "Model: ",
    "ragHub.knowledgeBase.collectionLabel": "Collection: ",
    "ragHub.document.title": "Document Ingestion",
    "ragHub.document.status.pending": "Pending",
    "ragHub.document.status.running": "Processing",
    "ragHub.document.status.succeeded": "Ingested",
    "ragHub.document.status.failed": "Failed",
    "ragHub.document.status.cancelled": "Cancelled",
    "ragHub.document.unknownSize": "Unknown size",
    "ragHub.document.uploadHint": "Local files are streamed by Rust. Maximum file size: {size}.",
    "ragHub.document.uploadUnsupported": "This service does not advertise file upload support.",
    "ragHub.document.processMode": "Processing Mode",
    "ragHub.document.chunkMode": "Chunk Ingestion",
    "ragHub.document.pipelineMode": "Pipeline Ingestion",
    "ragHub.document.chunkStrategy": "Chunk Strategy",
    "ragHub.document.pipelineLabel": "Pipeline",
    "ragHub.document.fileUploadDisabled": "File upload is disabled for this service",
    "ragHub.document.filePlaceholder": "Choose a document to ingest",
    "ragHub.document.selectKnowledgeBaseFirst": "Select a knowledge base first",
    "ragHub.document.selectFile": "Choose File",
    "ragHub.document.ingesting": "Ingesting",
    "ragHub.document.upload": "Upload and Ingest",
    "ragHub.document.urlImportDisabled": "URL ingestion is disabled for this service",
    "ragHub.document.downloading": "Downloading",
    "ragHub.document.urlImport": "Ingest URL",
    "ragHub.document.urlSecurityHint":
      "Only public HTTP(S) documents are allowed. Private, loopback, and private-redirect URLs are rejected.",
    "ragHub.document.urlCapabilityDisabled":
      "URL ingestion is disabled by this service's capabilities.",
    "ragHub.document.jobCurrent": "Current job: ",
    "ragHub.document.stageComplete": "Complete",
    "ragHub.document.selectKnowledgeBaseEmpty": "Refresh and select a knowledge base first.",
    "ragHub.document.empty": "This knowledge base has no documents yet.",
    "ragHub.document.chunkCount": "{count} chunks",
    "ragHub.document.hideChunks": "Hide Chunks",
    "ragHub.document.showChunks": "View Chunks",
    "ragHub.document.retrying": "Retrying",
    "ragHub.document.retry": "Retry Ingestion",
    "ragHub.document.showJobHistory": "View Job History",
    "ragHub.document.hideJobHistory": "Hide Job History",
    "ragHub.document.jobHistory": "Ingestion Job History",
    "ragHub.document.jobAttempt": "Attempt {attempt}",
    "ragHub.document.jobOperation": "Operation: {operation}",
    "ragHub.document.jobStarted": "Started: {time}",
    "ragHub.document.jobCompleted": "Completed: {time}",
    "ragHub.document.jobParent": "Parent job: {jobId}",
    "ragHub.document.jobError": "{code}: {message}",
    "ragHub.document.characterCount": "{count} characters",
    "ragHub.document.tokenCount": "{count} tokens",
    "ragHub.document.noChunks": "No chunks.",
    "ragHub.search.title": "Search Experiment",
    "ragHub.search.subtitle": "Run retrieval with optional reranking in one request.",
    "ragHub.search.scope": "Search Scope",
    "ragHub.search.scopeHint": "Select multiple knowledge bases",
    "ragHub.search.loadKnowledgeBasesFirst":
      "Load knowledge bases before selecting a search scope.",
    "ragHub.search.queryLabel": "Search Query",
    "ragHub.search.queryPlaceholder": "Enter a question to search",
    "ragHub.search.topK": "Retrieval Count Top K",
    "ragHub.search.serviceLimit": "Service limit {limit}",
    "ragHub.search.enableRerank": "Enable Reranking",
    "ragHub.search.rerankHint": "Improve the final ordering",
    "ragHub.search.rerankUnsupported": "This service does not advertise this capability",
    "ragHub.search.topN": "Final Count Top N",
    "ragHub.search.searching": "Searching",
    "ragHub.search.start": "Start Search",
    "ragHub.search.rerankingCandidates": "Reranking Independently",
    "ragHub.search.rerankCandidates": "Rerank Current Candidates",
    "ragHub.search.searchingAnnouncement": "Searching knowledge bases",
    "ragHub.search.rerankingAnnouncement": "Independently reranking current candidates",
    "ragHub.search.selectedKnowledgeBases": "{count} knowledge bases selected",
    "ragHub.search.capabilityLimits": " · Limited by service capabilities",
    "ragHub.search.localLimits": " · Using local safety limits",
    "ragHub.search.rerankCandidateCount":
      " · {count} candidates can be submitted for independent reranking",
    "ragHub.search.rerankCapabilityRequired":
      " · Available when service capabilities explicitly enable rerank",
    "ragHub.search.resultViewLegend": "Result View",
    "ragHub.search.results": "Search Results",
    "ragHub.search.rerankedResults": "Independent Rerank",
    "ragHub.search.searchTiming": "Search Timing",
    "ragHub.search.retrievalTiming": "Retrieval {ms} ms",
    "ragHub.search.rerankTiming": "Rerank {ms} ms",
    "ragHub.search.totalTiming": "Total {ms} ms",
    "ragHub.search.requestId": "Request {id}",
    "ragHub.search.warningRerankUnavailable":
      "The reranking service is unavailable. Results use the original retrieval order.",
    "ragHub.search.rawResultsFallback":
      "This service did not return raw retrieval results, so the final results are shown on the left for compatibility.",
    "ragHub.search.rawResults": "Raw Retrieval",
    "ragHub.search.rawResultsSubtitle": "Candidate order returned by vector search",
    "ragHub.search.finalResults": "Final Results",
    "ragHub.search.finalResultsSubtitle": "Results passed to Agent after reranking",
    "ragHub.search.independentRerankTiming": "Independent Rerank Timing",
    "ragHub.search.candidateTiming": "Candidate processing {ms} ms",
    "ragHub.search.candidateInput": "Candidate Input",
    "ragHub.search.candidateInputSubtitle":
      "Snapshot of candidates submitted to the independent rerank endpoint",
    "ragHub.search.independentRerankSubtitle":
      "Independent ordering that does not replace the original search response",
    "ragHub.search.hitCount": "{count} hits",
    "ragHub.search.sourceDocumentUnavailable": "Source document not returned",
    "ragHub.search.rankBeforeAfter": "Before rerank → after rerank",
    "ragHub.search.currentRank": "Current rank",
    "ragHub.search.noHits": "No matching results",
    "ragHub.search.empty": "Enter a question to compare raw retrieval with final reranked results.",
    "ragHub.notice.serviceSaved":
      "Service settings saved. Add credentials separately through the system-native secure prompt.",
    "ragHub.notice.credentialCancelled":
      "Credential entry was cancelled. The existing configuration is unchanged.",
    "ragHub.notice.credentialSaved":
      "Rust wrote the credential directly to the system vault; the frontend never accessed the key.",
    "ragHub.notice.credentialCleared": "The credential was removed from the system vault.",
    "ragHub.notice.serviceDeleted": "The service settings and credentials were deleted.",
    "ragHub.notice.connectionSucceeded": "Connection succeeded. Protocol version: {version}.",
    "ragHub.notice.knowledgeBaseCreated": "Knowledge base “{name}” was created.",
    "ragHub.notice.knowledgeBaseRenamed": "Knowledge base renamed to “{name}”.",
    "ragHub.notice.knowledgeBaseDeleted": "Knowledge base “{name}” was deleted.",
    "ragHub.notice.rerankComplete":
      "Independent reranking completed. Switched to the independent rerank view.",
    "ragHub.notice.documentSubmitted": "Document submitted and waiting for ingestion",
    "ragHub.notice.urlDocumentSubmitted":
      "URL document downloaded safely and waiting for ingestion",
    "ragHub.notice.jobAccepted": "{message} (job {jobId}).",
    "ragHub.notice.documentSucceeded":
      "Document parsing, chunking, and vector ingestion completed.",
    "ragHub.notice.pollingPaused":
      "Polling paused. Job {jobId} is still running in the background; refresh later to see the result.",
    "ragHub.notice.retrySubmitted": "The document ingestion job was resubmitted.",
    "ragHub.notice.retrySucceeded": "Retry succeeded. The document is now ingested.",
    "ragHub.notice.documentDeleted": "The document, chunks, and vectors were deleted.",
    "ragHub.error.saveBeforeCredential":
      "Save the service settings before opening the system-native credential prompt.",
    "ragHub.error.saveBeforeTest":
      "Save the current service settings and API key before testing the connection.",
    "ragHub.error.knowledgeBaseAdminRequired":
      'Creating a knowledge base requires a management key with knowledgeBaseIds=["*"].',
    "ragHub.error.invalidIngestionConfig": "The ingestion configuration is invalid.",
    "ragHub.error.documentFailed": "Document ingestion failed. You can retry it.",
    "ragHub.error.noRetryableJob": "This document has no failed job that can be retried.",
    "ragHub.error.retryFailed": "The retry still failed.",
    "ragHub.confirm.clearCredential":
      "Remove this RAG credential from the system credential vault?",
    "ragHub.confirm.deleteKnowledgeBase":
      "Delete the empty knowledge base “{name}”? This action cannot be undone.",
    "ragHub.confirm.deleteDocument":
      "Delete document “{name}”? Its chunks and vectors will also be removed.",
    ...
    "settings.groupIntegrationsCoding": "Integrations & coding",
    ...
    /* ── Settings About ── */
    "settings.aboutTitle": "About Agent",
    ...
    "settings.aboutInstalledDesc":
      "The update package has been installed. Restart Agent to use it.",
    "settings.aboutRestarting": "Restarting app",
    "settings.aboutRestartingDesc": "Agent is quitting and opening again.",
    ...
    "settings.agentDevModeDesc":
      "Same as Agent mode, but also writes each streaming request and response line-by-line to ~/.agent/debug/<conversationId>.jsonl",
    ...
    "settings.systemToolsBuiltinDesc":
      "Built-in tools that Agent registers automatically in tool mode. Read-only list; click the eye icon for details.",
    "settings.systemToolsCustomDesc":
    ...
    "settings.approval.title": "Execution and approvals",
    "settings.approval.description":
      "Control when Agent can run tools directly and when it must wait for your confirmation.",
    "settings.approval.mode.ask":
      "Workspace reads run automatically; writes, commands, network, MCP, and external paths require approval.",
    "settings.approval.mode.agent":
      "Normal workspace writes run automatically; deletes, commands, network, MCP, and boundary escapes require approval.",
    "settings.approval.mode.full":
      "All enabled tools run automatically, including access outside the workspace.",
    "settings.approval.allowWorkspaceWrites": "Allow workspace writes automatically",
    "settings.approval.allowWorkspaceWritesDesc":
      "Write and Edit can modify the current project directly; Delete still requires approval.",
    "settings.approval.allowCommands": "Allow commands automatically",
    "settings.approval.allowCommandsDesc":
      "Bash and managed processes can run without per-call approval.",
    "settings.approval.allowNetwork": "Allow network access automatically",
    "settings.approval.allowNetworkDesc":
      "HTTP and other network tools can run without per-call approval.",
    "settings.approval.allowMcp": "Allow MCP tools automatically",
    "settings.approval.allowMcpDesc": "Enabled MCP integrations can execute actions directly.",
    "settings.approval.allowOutsideWorkspace": "Allow access outside the workspace",
    "settings.approval.allowOutsideWorkspaceDesc":
      "File paths and command working directories may cross the current project boundary.",
    ...
    "settings.remoteDesc": "Control your local Agent remotely via cloud Gateway",
    ...
    "settings.skillsImportDesc":
      "Scan local Claude Code, Codex, and CodeBuddy skill directories, then pick skills to import into Agent.",
