...
macro_rules! app_invoke_handler {
    () => {
        tauri::generate_handler![
            ...
            commands::rag::rag_hub_create_knowledge_base,
            commands::rag::rag_hub_update_knowledge_base,
            commands::rag::rag_hub_delete_knowledge_base,
            commands::rag::rag_hub_list_documents,
            commands::rag::rag_hub_upload_document,
            commands::rag::rag_hub_import_document_url,
